  ...
  setMode: function(newMode, silent) {
    ...
    _.forEach(this.userData, function(currentUserData) {
      ...
      if (currentUserData.cursor) {
          currentUserData.coords.current = currentRolii.state.pos;
      ...
      /*var currentMid = this._getMidInputCoords(currentUserData.coords.old,{
        x: currentRoliiX(),
        y: currentRoliiY()
    });*/
    ...
    /*var currentMid = {
        ...
        this.ctx.beginPath(); //IS THIS WHERE IT GETS THE DUMB CUSRORS
        this.ctx.moveTo(currentMid.x, currentMid.y);
        //this.ctx.moveTo(currentRoliiX(), currentRoliiY());
